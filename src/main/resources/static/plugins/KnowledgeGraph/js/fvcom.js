var app = new Vue({
  ...
  methods: {
    ...
    createHistoryTrendGraph() {
      ...
      let that = this;
      $.ajax({
        url: "/static/KnowledgeGraph/assets/fvcom/researchTrend.json",
        type: "get",
        dataType: "json",
    ...
    createHistoryCountryGraph() {
      ...
      if (this.worldData) {
        this.$nextTick(() => {
          ...
          $.ajax({
            url: "/static/KnowledgeGraph/assets/fvcom/researchCountry.json",
            type: "get",
            dataType: "json",
    ...
    prepareLeafletMap() {
      ...
      if (this.locationOfModel.length === 0) {
        $.ajax({
          url: "/static/KnowledgeGraph/assets/fvcom/locationOfModel.json",
          type: "get",
