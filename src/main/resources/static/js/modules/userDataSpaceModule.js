        ...
        methods: {
            ...
            cancelMutiSelect(eval) {
                for (var i = 0; i < this.downloadDataSet.length; i++) {
                    if (this.downloadDataSet[i].uid === eval.uid) {
                        //删除
            ...
            userDownload() {
                ...
                if (this.downloadDataSet.length > 0) {
                    ...
                    let url = DATACONTAINER +"/data/" + keys;
                    window.open(url)
            ...
            right_download() {
                ...
                //下载接口
                if (id != undefined) {
                    window.open(DATACONTAINER + '/data/' + id);
                } else {
            ...
            renameConfirm() {
                ...
                for (let i = 0; i < this.myFileShown.length; i++) {
                    if (this.myFileShown[i].folder === true)
                        folderName.push(this.myFileShown[i].name + '.' + this.myFileShown[i].suffix)
                }
                if (a)
                    this.$alert('This name is existing in this path, please input a new one.', 'Tip', {
                        type: 'warning',
