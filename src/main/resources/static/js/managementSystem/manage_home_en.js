new Vue({
    ...
    methods: {
        ...
        loadEarth(){
            ...
            myChart.setOption({
                title: {
                    text: 'Distribution of Service Nodes',
                    left: 'center',
                    textStyle: {
                        color: '#ffffff'
                    }
        ...
        drawResourceCount(){
            ...
            for(let i=0,len=this.resourceCount.length;i<len;i++){
                resourceCountData.push({"value":this.resourceCount[i].count,"name":this.itemNameEn[i]})
            }
        ...
        drawItemViewCount(){
            ...
            myChart.setOption({
                title: {
                    text: 'Statistics of Items Views-'+this.itemNameEn[this.itemIndex],
                    left: 'center',
                    textStyle: {
                        color: '#ffffff'
                    },
        ...
        drawServiceUseCount(){
            ...
            myChart.setOption({
                ...
                title: {
                    text: 'Statistics of Service invocation-'+this.defaultItemShow,
                    left: 'center',
                    textStyle: {
                        color: '#ffffff'
                    }
