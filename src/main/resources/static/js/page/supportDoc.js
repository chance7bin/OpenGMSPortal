var vue = new Vue({
        ...
        methods: {
            ...
            */
            ...
            foldTree(){
                let treeDom = this.$refs.contentsTree.$el

                treeDom.style.transition = '.3s'

                let height = treeDom.style.height

                this.expand_foldDom(treeDom,this.treeHeight_former)

                this.treeHeight_former = height;
            },

            expand_foldDom(dom,toLength){
                dom.style.height = toLength
            },

            foldDom(dom,toLength){
