var userDraftBox = Vue.extend(
    {
        ...
        data(){
            return{
                ...
                computableModelDraftList:{
                    create:[],
                    edit:[],
                },

                conceptualModelDraftList:{
                    create:[],
                    edit:[],
                },

                logicalModelDraftList:{
                    create:[],
                    edit:[],
                },
        ...
        methods:{
            ...
            loadDraft(){
                axios.get('/draft/listByUser',{
                    ...
                    if(res.data.code==0){
                        ...
                        this.draftList=data
                        this.divideDraftList(this.draftList)
                    }else{
            ...
            divideDraftList(list){
                let i=0,ele
                this.modelItemDraftList = {
                    create:[],
                    edit:[],
                }
                this.conceptualModelDraftList = {
                    create:[],
                    edit:[],
                }
                this.logicalModelDraftList = {
                    create:[],
                    edit:[],
                }
                this.computableModelDraftList = {
                    create:[],
                    edit:[],
                }
                this.dataItemDraftList = {
                    create:[],
                    edit:[],
                }
                this.conceptDraftList = {
                    create:[],
                    edit:[],
                }
                this.spatialDraftList = {
                    create:[],
                    edit:[],
                }
                    ...
                    switch (ele.itemType.toLowerCase()) {
                        case 'modelitem':
                            if (ele.editType == 'create') {
                                ...
                                this.modelItemDraftList.edit.push(ele)
                            }
                        ...
                        case 'unit':
                            if (ele.editType == 'create') {
                                ...
                                this.unitDraftList.edit.push(ele)
                            }
                            break;
            ...
            viewDraftDetail(draft){
                this.draftDetailDialog = true
                this.draftShow=draft
                let cls=typeof(this.draftShow.content.classification)=="undefined"?[]: this.draftShow.content.classification
                let ids=[];
                for(let i=0;i<cls.length;i++){
                    for(let j=0;j<2;j++){
                        for(let k=0;k<this.treeData[j].children.length;k++){
                            ...
                            if(children==null) {
                                if (cls[i] == this.treeData[j].children[k].oid) {
            ...
            deleteDraftClick(oid){
                this.$confirm('Are you sure to delete this draft?', 'Tips', {
                    confirmButtonText: 'Yes',
                    cancelButtonText: 'No',
                    type: 'warning'
                }).then(() => {
                    this.deleteDraft(oid)
                    this.draftDetailDialog=false
                }).catch(() => {
                });
            },
        ...
        mounted(){
            ...
            $(() => {
                ...
                this.draftCardWidth = document.getElementById('draftBoxContainer').offsetWidth
                window.onresize = () => {
                    console.log('come on ..');
