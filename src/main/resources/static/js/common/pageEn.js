...
var  page = {
    ...
    "getPageListModel":function(pageCount,currentPage){
        ...
        var appendStr ="";
        appendStr+="<li class='"+prePageClass+"' page-data='1' page-rel='firstpage'><b>first</b></li>";
        appendStr+="<li class='"+prePageClass+"' page-data='"+prePage+"' page-rel='prepage'><b>pre</b></li>";
        ...
        appendStr+="<li class='"+nextPageClass+"' page-data='"+nextPage+"' page-rel='nextpage'><b>next</b></li>";
        appendStr+="<li class='"+nextPageClass+"' page-data='"+pageCount+"' page-rel='lastpage'><b>last</b></li>";
       return appendStr;
