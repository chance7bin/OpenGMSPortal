...
public class TaskListener{
    ...
    // @PostConstruct
    @Async
    public void taskListener() throws IOException, URISyntaxException, InterruptedException {
        ...
        while (true){
            ...
            List<RunTask> runningTasks = runTaskDao.findAllByStatus(1);
            for (RunTask runningTask : runningTasks) {
                runService.updateTaskFromMSC(runningTask.getTaskId());
            }
